...
Include your API key in the `X-API-Key` header of your requests. Platnova does **not** accept the API key in an `Authorization` header — that header is reserved for JWT and Token credentials, which are not used for API integrations.
