...
Government ID types when your flow asks for a document category in this group (for example alongside address or identity checks).

| Field | Description |
| --- | --- |
| `passport` | Passport — international travel document used as government ID. |
| `drivers_license` | Driver’s license — government-issued driving license used as ID. |
